...
MOCK_GIT_LOG = [
    ...
    "fabd2ab|§MRG: Merge pull request #3 from SekmenDev/feature/add-other-conventional-commit-ci-components|§|§",
...
MOCK_PULL_REQUEST_COMMITS = [
    {
        "commit": {
            "message": "MRG: Merge pull request #3 from SekmenDev/feature/add-other-conventional-commit-ci-components"
        }
    },
...
EXPECTED_PULL_REQUEST_START_RELEASE_NOTES_WITH_NON_GENERATED_SECTION = "\n".join(
    [
        ...
        "",
        "### Other",
        "- Merge pull request #3 from SekmenDev/feature/add-other-conventional-commit-ci-components",
        "",
